...
\begin{frame}
  ...
  {
    \includegraphics[width=1.0\textwidth]{figures/simu_locus_precision_recall.pdf}\\
  }{
    \begin{align*}
...
\begin{frame}
  ...
  \myfulltwocolumn{0.6}{T}
  {
    \includegraphics[width=1.0\textwidth]{figures/bvslr_locus_prediction_simu.png}\\
  }{
    \scriptsize
    \begin{itemize1}
      \item 6000 causal loci (120 from each of the 50 simulations)
      \item 4000 non-causal loci (80 from each of the 50 simulations)
    \end{itemize1}
  }
\end{frame}
...
\begin{frame}
  ...
  \mytwocolumn{0.5}{T}
  {
    \center
    \vskip -2em
    \includegraphics[width=1.0\textwidth]{figures/simu_recall_full.pdf} \\
  }{
    \center
    \vskip -2em
    \includegraphics[width=1.0\textwidth]{figures/simu_recall_precisionld_02.pdf}\\
  }
\end{frame}
...
\begin{frame}
  \frametitle{Top BVSLR predicted loci}
  \vskip -2em
  {\center \scriptsize
